...
alias scrape_uni='conda activate uni_scraper && cd ~/Info/Python/UniScraper && python uni_scraper.py'
...
alias astro_talk='pdfpc -Ss ~/LatexDocs/AstroStellarNeighbourhood/StellarNeighbourhood.pdf'
