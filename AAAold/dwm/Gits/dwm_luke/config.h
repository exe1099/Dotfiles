...
static const char *fonts[]          = { "monospace:size=9", "Hack Nerd Font:pixelsize=9:antialias=true:autohint=true"  };
...
static const Rule rules[] = {
	...
	*/
	...
	{ "libreoffice-startcenter|Soffice", NULL,       NULL,       	    1 << 7,       0,           0,         0,        -1 },
...
static Key keys[] = {
	...
	TAGKEYS(			XK_9,		9)
	TAGKEYS(			XK_F5,		9)
	TAGKEYS(			XF86XK_Launch1,		10)
    { 0,			    XF86XK_Launch1,		view,		{.ui = 1 << 10} },  // view mail by only meta key pressing
	{ MODKEY,			    XK_0,		view,		{.ui = ~0 } },  // view all
	{ MODKEY,			XK_Return,	spawn,		{.v = termcmd } },
	{ MODKEY|ShiftMask,		XK_0,		tag,		{.ui = ~0 } },
    { MODKEY|ShiftMask,		XK_s,		togglescratch,	{.ui = 0} },
	{ MODKEY,			    XK_a,		spawn,	SHCMD("pavucontrol") },
	{ MODKEY,			    XK_Tab,		view,		{0} },  // cycle through open windows
	{ MODKEY,			    XK_q,		killclient,	{0} },  // close window
	{ MODKEY|ShiftMask,		XK_w,		spawn,		SHCMD("~/.config/scripts/wallpaper_change Current") }, // change wallpaper
	{ MODKEY,			    XK_r,		spawn,		SHCMD("st -e ranger") },  // open terminal with ranger
    ...
    { 0, XF86XK_MonBrightnessUp,	spawn,		SHCMD("~/.config/scripts/brightness 1") },
    { 0, XF86XK_MonBrightnessDown,	spawn,		SHCMD("~/.config/scripts/brightness -1") },
    { 0, XF86XK_Display,	        spawn,		SHCMD("~/.config/scripts/display_select") },
